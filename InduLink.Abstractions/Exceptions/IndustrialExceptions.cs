...
namespace InduLink.Exceptions
{
    ...
    /// </summary>
    public class InduLinkunicationException : Exception
    {
        /// <summary>
        ///     使用指定的错误消息初始化 <see cref="InduLinkunicationException"/> 类的新实例。
        /// </summary>
        /// <param name="message">描述错误的消息文本。</param>
        public InduLinkunicationException(string message) : base(message) { }

        /// <summary>
        ///     使用指定的错误消息和对导致此异常的内部异常的引用来初始化
        ///     <see cref="InduLinkunicationException"/> 类的新实例。
        /// </summary>
        /// <param name="message">描述错误的消息文本。</param>
        /// <param name="innerException">导致当前异常的异常；如果未指定内部异常，则为 null。</param>
        public InduLinkunicationException(string message, Exception innerException) : base(message, innerException) { }
    }
    ...
    /// </summary>
    public sealed class IndustrialConnectionException : InduLinkunicationException
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class IndustrialWriteUncertainException : InduLinkunicationException
    {
    ...
    /// </summary>
    public sealed class IndustrialTimeoutException : InduLinkunicationException
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class IndustrialProtocolException : InduLinkunicationException
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class IndustrialAddressParseException : InduLinkunicationException
    {
        /// <summary>
    ...
    ///     或目标值超出目标类型的有效范围时抛出。
    /// </summary>
    public sealed class IndustrialDataConversionException : InduLinkunicationException
    {
        /// <summary>
