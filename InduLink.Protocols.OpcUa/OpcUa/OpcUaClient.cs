...
using DataValue = InduLink.Abstractions.DataValue;
using ReadRequest = InduLink.Abstractions.ReadRequest;
using WriteRequest = InduLink.Abstractions.WriteRequest;
...
namespace InduLink.Protocols.OpcUa
{
    ...
    public sealed class OpcUaClient : IndustrialClientBase, INativeSubscriptionClient, IRegisterClient, IEventSubscriptionClient
    {
        ...
        protected override async Task ConnectCoreAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var session = await new DefaultSessionFactory(null).CreateAsync(configuration, endpoint, false, false,
                    "InduLink-" + DeviceId, (uint)_options.SessionTimeoutMilliseconds,
        ...
        private async Task<ApplicationConfiguration> CreateConfigurationAsync(CancellationToken cancellationToken)
        {
            var config = new ApplicationConfiguration
            {
                ...
                ApplicationUri = "urn:" + Utils.GetHostName() + ":InduLink",
            ...
            CancellationToken cancellationToken)
        {
            ...
            subscription.DisplayName = "InduLink-" + registration.Id;
